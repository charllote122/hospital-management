...
# SECRET_KEY - with fallback for build time
SECRET_KEY = config('SECRET_KEY', default='django-insecure-build-key-not-for-production')
...
# Database - Use SQLite for build, PostgreSQL for runtime
